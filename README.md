...
shape, warmup, measurement window, repetitions, parity tolerances, and a 10%
median end-to-end promotion threshold. Planning, inspection, and the default
...
generated by the executor; never hand-author measurements.
...
These settings are implementation candidates, not objective changes. Muon,
